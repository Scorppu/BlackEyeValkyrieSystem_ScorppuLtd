...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Get existing allergies - use the global variable that was set in the HTML
    const patientAllergies = patientAllergiesData;
    const drugMap = {};
    
    // Get drugs data - use the global variable that was set in the HTML
    const allDrugs = allDrugsData;
